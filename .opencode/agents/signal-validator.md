...
permission:
  ...
  mcp__tradingview__draw_shape: allow
  mcp__tradingview__ui_mouse_click: allow
  mcp__tradingview__ui_click: allow
  mcp__tradingview__symbol_search: allow
  mcp__tradingview__symbol_info: allow
  WebFetch: allow
  Read: allow
  Bash: allow
