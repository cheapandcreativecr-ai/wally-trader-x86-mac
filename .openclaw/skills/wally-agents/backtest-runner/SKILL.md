...
metadata:
  openclaw:
    ...
    - terminal
---
<!-- generated from system/agents/backtest-runner.md by adapters/openclaw/transform.py -->
<!-- Original CC tools: Bash, Write, Read, mcp__tradingview__chart_set_timeframe, mcp__tradingview__data_get_ohlcv -->
