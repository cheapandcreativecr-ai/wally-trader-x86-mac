...
description: Use cuando el usuario comparta una señal de trading de otra persona/comunidad
  (Discord, Telegram, Twitter) para validarla contra su sistema propio ANTES de ejecutarla.
  Acepta cualquier símbolo (no solo BTC) y direcciones LONG/SHORT con precios. Devuelve
  GO/NO-GO con score de confluencia y size recomendado.
version: 1.0.0
metadata:
  openclaw:
    tags:
